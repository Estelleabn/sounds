...
class SoundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post sounds_url, params: { sound: { category: @sound.category, id: @sound.id, name: @sound.name } }
    end
  ...
  test "should update sound" do
    patch sound_url(@sound), params: { sound: { category: @sound.category, id: @sound.id, name: @sound.name } }
